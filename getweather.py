...
def queryRealTimeWeatherInfo(code):
    ...
    url = "https://api.seniverse.com/v3/weather/now.json?key=zkffhieb2wd92rwt&location=%s&language=zh-Hant&unit=c" % code
...
def showRealTimeWeatherInfo(info):
    ...
    template = u"{name}, {last_update}, 天氣實況: 氣溫{temperature}℃, {text}"
